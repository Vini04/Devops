...
public class EmployeeServiceImpl implements EmployeeService{
	...
	// Reuses the getEmployeeById method for validation.
	// Updates the existing employee object’s fields.
	// Persists the updated object using .save().
	@Override
	public Employee updateEmployee(Long id, Employee updatedData) {
		// First, fetch the existing employee from DB (will throw if not found)
	    ...
	    // Save the updated employee back to the database and return it
